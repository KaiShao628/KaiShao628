...
public sealed class InMemoryLedgerRepository : ILedgerRepository
{
    ...
    public InMemoryLedgerRepository(TimeProvider timeProvider)
    {
    }
    ...
    private static FamilyMember Clone(FamilyMember item) => new()
    {
        Id = item.Id,
        Name = item.Name,
        Role = item.Role,
    ...
    private static LedgerCategory Clone(LedgerCategory item) => new()
    {
        Id = item.Id,
        Name = item.Name,
        Kind = item.Kind,
